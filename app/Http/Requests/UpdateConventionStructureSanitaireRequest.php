...
class UpdateConventionStructureSanitaireRequest extends FormRequest
{
    /**
    ...
    {
        $conventionId = $this->route('convention_structure_sanitaire')?->getKey();
        ...
        return [
            ...
            'numero' => [
                ...
                'string',
                'max:255',
                'unique:conventions_structure_sanitaires,numero,' . $conventionId,
            ],

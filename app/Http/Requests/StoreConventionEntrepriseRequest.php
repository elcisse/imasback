...
class StoreConventionEntrepriseRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'numero' => ['required', 'string', 'max:255', 'unique:conventions_entreprises,numero'],
            ...
            'signee_par_entreprise' => ['nullable', 'string', 'max:255'],

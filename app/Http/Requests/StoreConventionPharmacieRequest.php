...
class StoreConventionPharmacieRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'numero' => ['required', 'string', 'max:255', 'unique:conventions_pharmacies,numero'],
            ...
            'taux_remise_medicament' => ['nullable', 'numeric', 'between:0,100'],

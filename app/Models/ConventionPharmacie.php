...
class ConventionPharmacie extends Model
{
    use HasFactory;
    use SoftDeletes;

    protected $table = 'conventions_pharmacies';
    ...
    protected $casts = [
        ...
        'date_effet' => 'date',
        'date_fin' => 'date',
        'taux_remise_medicament' => 'decimal:2',
    ...
    /**
     * Get the pharmacy prestataire linked to the convention.
     */
    public function prestataire()
    {
        return $this->belongsTo(Prestataire::class)
            ->where('type', Prestataire::TYPE_PHARMACIE);
    }
}

...
return new class extends Migration
{
    ...
    {
        Schema::create('conventions_structure_sanitaires', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['mutuelle_id', 'prestataire_id', 'date_effet'], 'conventions_structures_mutuelle_prestataire_effet_unique');
            $table->index(['prestataire_id', 'statut'], 'conventions_structures_prestataire_statut_index');
        });
    }
    ...
    {
        Schema::dropIfExists('conventions_structure_sanitaires');
    }
};
